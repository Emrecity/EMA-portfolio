    ...
    <section id="about" className="about-container">
      ...
      <div className="flex flex-col md:flex-row md:justify-evenly 2xl:justify-around gap-5 space-3 mt-20">
        <div className="text-justify md:w-xl 2xl:w-5xl flex flex-col py-5 space-y-5 ">
          <h2 className="text-h3">Emmanuel Owusu</h2>
          <p className="text-p">
      ...
      <div className="my-16 grid sm:grid-cols-2 md:grid-cols-3 gap-5 dark:bg-white/30 bg-cyan-500 p-3 md:p-5  rounded-xl">
        <div className="about-card text-white/70  dark:text-slate-500  dark:bg-white/50">
          ...
          <div>
            <strong className=" text-p ">B.Sc Information Technology</strong>
            <p className="text-csm">Aamusted (USTED), 2020 - 2024 </p>
          </div>
          <div>
            <strong className=" text-p ">General Arts (WASSCE)</strong>
            <p className="text-csm">Okess, 2016 - 2019 </p>
          </div>
        </div>
        <div className="about-card text-white/70  dark:text-slate-500  dark:bg-white/50">
          <h3 className="text-h4 dark:underline dark:underline-offset-10">
          ...
          <div>
            <strong className=" text-p">Software Developer (Remote)</strong>
            <p className="text-csm">Opencastgh, July 2022 - Dec 2022 </p>
          </div>
          <div>
            <strong className=" text-p ">IT Support Intern</strong>
            <p className="text-csm">KATH, July 2021 - Dec 2021</p>
          </div>
        </div>
        <div className="about-card text-white/70   dark:text-slate-500  dark:bg-white/50">
          <h3 className="text-h4  dark:underline dark:underline-offset-10">
          ...
          <div>
            <strong className=" text-p ">
              IT Facilator (National service)
            </strong>
            <p className="text-csm">Meduma M/A, Oct 2024 - Aug 2025 </p>
          </div>
          <div>
            <strong className=" text-p ">Software Engineer</strong>
            <p className="text-csm">Samasoft Tech, July 2023 - Dec 2023 </p>
          </div>
        </div>
      </div>
    </section>
